...
public class MedicoControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código http 400 quando informacoes de entrada estão inválidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devovler código Http 200 quando informaçõe estão válidas")
    @WithMockUser
